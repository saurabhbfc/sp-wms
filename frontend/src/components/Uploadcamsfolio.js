...
function Uploadcamsfolio() {
  ...
  const [data, setData] = useState([]);   
    ...
    const processData = dataString => {
     ...
     var modelfolio = mongoose.model('cams_folio', wms_camsSchema, 'cams_folio');
     console.log(modelfolio);
      Axios.post('/api/savecamsfolio',
      list ,
      {mode: 'cors'},
      {headers:
            ...
            <div className="col-md-8">
              <div className="card">
                <div className="card-header ">
                  <h4 className="card-title"> Cams Folio </h4>
                  </div>
...
export default Uploadcamsfolio